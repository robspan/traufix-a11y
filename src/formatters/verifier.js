 ...
 *
 * @module formatters/verifier
 */

'use strict';

const { loadAllFormatters } = require('./loader');
const { sitemapResult, minimalResult, emptyResult, allFailingResult } = require('./_fixtures/sample-results');
